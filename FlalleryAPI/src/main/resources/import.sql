...
insert into artwork_category(id_category,name) values ('1', 'Sin categoria');
insert into artwork_category(id_category,name) values ('2', 'Cuadros');
insert into artwork_category(id_category,name) values ('0', 'Esculturas');

insert into artwork (id_artwork, description, img_url, name, owner, category, disponible_para_comprar) values ('e641d9ec-ca50-4002-b87b-464b6c7686a1', 'Drama|Musical|Romance', 'p05cjdsl.jpg', 'Porgy and Bess', 'lmlopez', '0', 'True');
insert into artwork (id_artwork, description, img_url, name, owner, category, disponible_para_comprar) values ('e641d9ec-ca50-4002-b87b-464b6c7686a2', 'Horror|Thriller|Western', '223736.jpg', 'Blood River', 'lmlopez', '0', 'True');
insert into artwork (id_artwork, description, img_url, name, owner, category, disponible_para_comprar) values ('e641d9ec-ca50-4002-b87b-464b6c7686a3', 'Comedy|Horror|Mystery|Thriller', 'p05cjdsl.jpg', 'Dylan Dog: Dead of Night', 'lmlopez', '0', 'True');
insert into artwork (id_artwork, description, img_url, name, owner, category, disponible_para_comprar) values ('e641d9ec-ca50-4002-b87b-464b6c7686a4', 'Comedy|Romance', '223736.jpg', 'Serendipity', 'lmlopez', '0', 'True');
insert into artwork (id_artwork, description, img_url, name, owner, category, disponible_para_comprar) values ('e641d9ec-ca50-4002-b87b-464b6c7686a5', 'Horror|Thriller', '223736.jpg', 'Loner (Woetoli)', 'mcampos', '2', 'True');
