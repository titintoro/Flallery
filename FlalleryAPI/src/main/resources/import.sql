...
insert into artwork (id_artwork, description, img_url, name, owner, category, disponible_para_comprar) values ('e641d9ec-ca50-4002-b87b-464b6c7686a3', 'Comedy|Horror|Mystery|Thriller', 'p05cjdsl.jpg', 'Dylan Dog: Dead of Night', 'lmlopez', '1', 'True');
insert into artwork (id_artwork, description, img_url, name, owner, category, disponible_para_comprar) values ('e641d9ec-ca50-4002-b87b-464b6c7686a4', 'Comedy|Romance', '223736.jpg', 'Serendipity', 'lmlopez', '1', 'True');
